...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pages_seafood_seafood_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./pages/seafood/seafood.component */
    "./src/app/pages/seafood/seafood.component.ts");

    var routes = [{
      path: '',
      component: _pages_seafood_seafood_component__WEBPACK_IMPORTED_MODULE_3__["SeafoodComponent"]
    }, {
      path: '**',
      redirectTo: '/'
    }];
  ...
  function srcAppPagesSeafoodSeafoodComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function SeafoodComponent(apiService, formBuilder) {
        ...
        this.separatorKeysCodes = [_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_1__["ENTER"], _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_1__["COMMA"]]; // idsForPackage: string[] = [];
      ...
      _createClass(SeafoodComponent, [{
              ...
              if (res.packagingOccurrence == null) {
                ...
                try {
                  for (var _iterator = _this13.provenanceFishes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    _this13.nodes = [].concat(_toConsumableArray(_this13.nodes), [{
                      ...
                      label: "Fish <".concat(fish.occurrence.fishId, "> Captured"),
                      data: {
                ...
                if (_this13.provenanceTransportation != null) {
                  ...
                  _this13.nodes = [].concat(_toConsumableArray(_this13.nodes), [{
                    ...
                    label: "Package <".concat(_this13.provenanceTransportation.occurrence.packageId, "> Transported"),
                    data: {
                ...
                if (_this13.provenanceEntry != null) {
                  ...
                  _this13.nodes = [].concat(_toConsumableArray(_this13.nodes), [{
                    id: entryNodeId,
                    label: "Package <".concat(_this13.provenanceEntry.occurrence.packageId, "> Registered In Inventory"),
                    data: {
                ...
                if (_this13.provenanceSelling != null) {
                  ...
                  _this13.nodes = [].concat(_toConsumableArray(_this13.nodes), [{
                    id: sellingNodeId,
                    label: "Package <".concat(_this13.provenanceSelling.occurrence.packageId, "> Sold"),
                    data: {
        ...
        value: function removeIdFromPackage(id) {
          ...
          var index = controller.value.indexOf(id);
        ...
        value: function addIdInPackage(event) {
          ...
          if ((value || '').trim()) {
            ...
            controller.markAsDirty(); // Reset the input value
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\falazigb\Documents\GitHub\SCIP-CaseStudy-2\ClientApplication\scip-client-application\frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
